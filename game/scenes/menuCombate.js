...
export default class MenuCombate extends Phaser.Scene {
  ...
  create() {
    ...
    this.talkButton.on("pointerdown", (pointer) => {
      ...
      this.talkOption1 = this.add.sprite(200, 700, "talkButton").setInteractive();
      this.talkOption2 = this.add.sprite(550, 700, "talkButton").setInteractive();
      this.talkOption3= this.add.sprite(850, 700, "talkButton").setInteractive();
      this.talkOption4 = this.add.sprite(1200, 700, "talkButton").setInteractive();
      
      this.talkOptionsVec = [this.talkOption1, this.talkOption2, this.talkOption3,this.talkOption4];
      ...
      this.talkOption1.on("pointerdown", (pointer) => {
        this.persuasion = 10;
        let text = this.add.text(200,500, "- Has elegido la opción 1, que da 10 de persuasión -");
        ...
        this.talkOption2.on("pointerdown", (pointer) => {
          this.persuasion = 20;
          let text = this.add.text(200,500, "- Has elegido la opción 2, que da 20 de persuasión -");
          text.setFont("Arial Black");
          text.setFontSize(50);
          this.timer = this.time.addEvent({
            delay: 2000,
          ...
          this.talkOption3.on("pointerdown", (pointer) => {
            this.persuasion = -30;
            let text = this.add.text(200,500, "- Has elegido la opción 3, que da -30 de persuasión -");
            text.setFont("Arial Black");
            text.setFontSize(50);
            this.timer = this.time.addEvent({
              delay: 2000,
            ...
            this.talkOption4.on("pointerdown", (pointer) => {
              this.persuasion = 0;
              let text = this.add.text(200,500, "- Has elegido la opción 4, que da 0 de persuasión -");
              text.setFont("Arial Black");
              text.setFontSize(50);
              this.timer = this.time.addEvent({
                delay: 2000,
      ...
      this.backButton2 = this.add.sprite(1200,150,"backButton").setInteractive();
