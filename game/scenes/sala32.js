...
export default class Sala32 extends SalaBase {
  ...
  create() {
    ...
    this.hijoFlorista = new Prop(this,this.sys.game.canvas.width / 2,600,"hijo_florista",this.player,60,50,true);
    this.hijoFlorista.play("hijo_florista", true);
    this.cliente = new Prop(this,1150,700,"cliente_bombones1",this.player,60,50,true);
